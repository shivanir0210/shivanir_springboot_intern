...
public class StudentService {
    ...
    public Student getstudentin(Integer id) {
    ...
    public StudentDTO getstudentbydto(Integer id) {
        Student s1=r.findById(id).orElse(new Student());
    ...
    public Page<Student> getallstudentsByPage(int page, int size) {
